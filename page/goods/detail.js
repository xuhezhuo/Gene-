...
Page({
  ...
  onLoad:function(options){
    ...
    if(goods_id==0){
      ...
      wx.request({
        url: app.globalData.serverUrl + "api.php?s=/Index/get_goods_by_id",
        data: {id:goods_id},
        ...
        success: function(res){
          ...
          goods_info.img=app.globalData.serverUrl+goods_info.img.substring(1);
          self.setData({
            goods_info:goods_info
          });
          WxParse.wxParse('introduction','html',goods_info.introduction,self);
  ...
  do_collection:function(){
    ...
    if(self.data.collection=="collection_1.png"){
       wx.request({
         url: app.globalData.serverUrl + "api.php?s=/Index/cancle_collection",
         data: {report_id:report_id,goods_id:self.data.goods_id},
         method: 'POST', // OPTIONS, GET, HEAD, POST, PUT, DELETE, TRACE, CONNECT
         // header: {}, // 设置请求的 header
         success: function(res){
