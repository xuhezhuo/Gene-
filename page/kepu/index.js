...
Page({
  ...
  onLoad:function(options){
    ...
    var self=this;
    wx.request({
      url: app.globalData.serverUrl + "api.php?s=/Index/get_kepu_by_page",
      data: {
      ...
      success: function(res){
       ...
       var faq_top10=res.data.data;
        ...
        for(let i=0;i<faq_top10.length;i++){
          faqArr.push(faq_top10[i].title); 
          faqArr.push(faq_top10[i].introduction);
          faq_top10[i].img=app.globalData.serverUrl+faq_top10[i].img.substring(1);
        } 
